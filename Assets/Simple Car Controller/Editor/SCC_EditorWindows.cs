...
public class SCC_EditorWindows : Editor {
    ...
    public static void CreateCamera() {
        ...
        if (!FindFirstObjectByType<SCC_Camera>()) {
            ...
            Selection.activeGameObject = FindFirstObjectByType<SCC_Camera>().gameObject;
    ...
    public static void CreateCanvas() {
        ...
        if (!FindFirstObjectByType<SCC_Dashboard>()) {
            ...
            Selection.activeGameObject = FindFirstObjectByType<SCC_Dashboard>().gameObject;
